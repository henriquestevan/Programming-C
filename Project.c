...
int main() {
    ...
    int senhaCorreta[6] = {6, 6, 3, 5, 7, 6};
    int mov, pos_inicial = 10, tentativas = 3, deslizamentos, pos_final;
    int qnt_0, qnt_2, qnt_4, qnt_6, qnt_8, qnt_9;


    printf("\nOlá, para abrir esse cofre você deverá adivinhar a senha!!\n");
    printf("\nA senha é composta de 6 dígitos, e para descobri-la, você deverá se deslocar por uma barra escolhendo a posição que\n");
    ...
    while (tentativas > 0) {
        qnt_0 = 1; qnt_2 = 0; qnt_4 = 0; qnt_6 = 0; qnt_8 = 0; qnt_9 = 0;
    ...
    if (tentativas == 0) {
        printf("\nVocê excedeu o número de tentativas permitidas. O cofre está bloqueado!\n");
    }
